...
def seed_expense_members():
    ...
    em19 = ExpenseMember(expense_id=9, user_id=3, amount_owed=7.50, settled=False)
    ...
    em24 = ExpenseMember(expense_id=11, user_id=5, amount_owed=3.05, settled=True)
    em25 = ExpenseMember(expense_id=11, user_id=6, amount_owed=3.05, settled=False)

    em26 = ExpenseMember(expense_id=12, user_id=4, amount_owed=10.00, settled=True)
    em27 = ExpenseMember(expense_id=12, user_id=6, amount_owed=10.00, settled=False)

    em28 = ExpenseMember(expense_id=13, user_id=5, amount_owed=5.00, settled=True)
    em29 = ExpenseMember(expense_id=13, user_id=6, amount_owed=5.00, settled=False)

    em30 = ExpenseMember(expense_id=14, user_id=4, amount_owed=5.97, settled=True)
    em31 = ExpenseMember(expense_id=14, user_id=5, amount_owed=5.97, settled=True)
    em32 = ExpenseMember(expense_id=14, user_id=6, amount_owed=5.97, settled=True)

    em33 = ExpenseMember(expense_id=15, user_id=4, amount_owed=50.00, settled=True)
    em34 = ExpenseMember(expense_id=15, user_id=5, amount_owed=50.00, settled=True)
    em35 = ExpenseMember(expense_id=15, user_id=6, amount_owed=50.00, settled=True)
    ...
    db.session.add_all([
      ...
      em29, em30, em31, em32, em33, em34, em35
    ])
    db.session.commit()
